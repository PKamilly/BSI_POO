...
public class Main{
    public static void main(String[] args){
        ...
        int opcao = 0;
        do{
            ConteudoDeAudio conteudoDeAudio;
            ...
            switch (opcao) {
                ...
                case 3:
                    ...
                    AudioBook novoAudioBook = new AudioBook(tituloAudioBook, autorAudioBook, duracaoAudioBook);
                    biblioteca.add(novoAudioBook);
                    System.out.println("AudioBook cadastrada!");
                    break;
